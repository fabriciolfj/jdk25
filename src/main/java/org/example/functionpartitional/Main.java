package org.example.functionpartitional;
...
public class Main {
    ...
    public static void main(String[] args) {       
        ...
        System.out.println();
        System.out.println("abc2Only2 (1): " + abc2Only2.apply(2.0, 1.0));
        System.out.println("abc2Only2 (2): " + abc2Only2.apply(2.0, 2.0));
        System.out.println("abc2Only2 (3): " + abc2Only2.apply(2.0, 3.0));
    }
}